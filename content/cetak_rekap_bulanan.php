...
<span>
                        ...
                        <a href="?hal=riwayat" class="btn btn-primary">Kembali</a>
                    </span>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <center><h3><b>History Transaksi</b></h3></center>
...
<!-- memilih data dari table view_nasabah-->
                        ...
                        $tampil = "SELECT * FROM  view_transaksi WHERE month(tanggal)=$bulan AND YEAR(tanggal)=$tahun ORDER BY id_transaksi DESC";
