...
-- Dumping data for table domsan1.admin: ~0 rows (approximately)
...
-- Dumping data for table domsan1.data_siswa: ~2 rows (approximately)
REPLACE INTO `data_siswa` (`id_siswa`, `id_user`, `nama`, `no_induk`, `foto`, `saldo`, `id_kelas`) VALUES
	(13, NULL, 'Muhammad Fahrur Rozi', '124366', '', 0.00, 3),
	(14, NULL, 'Nayla', '1234345', '', 0.00, 2);
...
-- Dumping data for table domsan1.user: ~1 rows (approximately)
